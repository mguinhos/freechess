//! A player's public profile: nickname and certified game history.
//!
...
use chess_core::PlayerParametersV1 as ContractParams;
use chess_core::PlayerStateV1 as ContractState;
