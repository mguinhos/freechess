//! The lobby: live games, the Elo ranking and player presence.
//!
...
use chess_core::LobbyParametersV1 as ContractParams;
use chess_core::LobbyStateV1 as ContractState;
